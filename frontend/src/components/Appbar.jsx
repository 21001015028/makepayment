...
export const Appbar = () => {
  ...
  return (
    <div className="shadow bg-black  text-white h-14 flex justify-between items-center md:px-10">
      <Link to={"/dashboard"}>
      ...
      <div className="flex items-center justify-center gap-2 mt-2">
        <Button label={"Logout"} onClick={signOutHandler} />
        <div className="flex flex-col justify-center h-full mr-4">
          {user?.firstName}
        </div>
        <div className="rounded-full h-10 w-10 p-4 text-black bg-slate-200 flex justify-center mr-2">
